...
class RecyclerBasketItemAdapter(
        context: Context,
        private var itemList: MutableList<MenuItem>,
        private val loadDefaultImage: Int,
        val listener: OnItemClickListener
) : RecyclerView.Adapter<RecyclerBasketItemAdapter.ItemListViewHolder>(), Filterable {

        private var fullMenuList = itemList
        ...
        private val searchFilter = object : Filter() {
                ...
                override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                        itemList.clear()
                        itemList.addAll(results!!.values as MutableList<MenuItem>)
                        notifyDataSetChanged()
                }
        }
